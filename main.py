...
folder = "main save"                # Variabel ini digunakan untuk menentukan folder mana tempat save digunakan
while (program == True):
    print("========================================================================================")
    ...
    if (action == 'login'):
        ...
        while(logged == True):      # Pengguna sudah masuk ke suatu akun
            ...
            # Jika action adalah load
            elif (action == 'load'):
                newuser, newgame, newriwayat, newkepemilikan = load()
                if ((newuser != None) and (newgame != None) and (newriwayat != None) and (newkepemilikan != None)):
                    dfuser, dfgame, dfriwayat, dfkepemilikan = newuser, newgame, newriwayat, newkepemilikan
